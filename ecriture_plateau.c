...
void ecriture_plateau(char plateau[17][17], char a_qui_de_jouer[]){
    /// Enregistre dans partie_en_pause.txt le plateau à deux dimensions fourni ainsi que le pseudo du joueur dont c'est le tour de jouer
    ...
    fprintf(pFichierPlateauW, "%s", a_qui_de_jouer);
